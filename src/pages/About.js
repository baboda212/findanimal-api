...
export default function About({animals, pageNo, maxPages, prevPage, nextPage, totalCount, setSearch,search, inputRef, setPageNo}) {
              ...
              return(
                  <div className='itemList' key={key} >
                      ...
                      <div className="text">
                          ...
                          <p>문의 : <a href='tel:{animal.careTel}'>{animal.careTel}</a>(누르면 전화연결됩니다.)</p>
                      </div>
                  </div>
              )
            })  
